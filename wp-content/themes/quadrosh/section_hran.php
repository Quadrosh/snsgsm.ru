...
<section class="backimage">
	<div class="square">
		<h2>САМЫЙ ЦЕННЫЙ КЛИЕНТ - <br>ПОСТОЯННЫЙ</h2>
		<p>Нам важно что бы ваши потребители были довольны. 
		По этому, доверив хранение нам, вы получаете удобный график и стабильное качество топлива, а следовательно довольных потребителей.</p>
		...
		<div class="iconline">
			...
			<svg version="1.1" 
				...
				x="0px" y="0px"
				viewBox="-195 287 220 220" 
				style="enable-background:new -195 287 220 220;" 
				xml:space="preserve"
				>
			<style type="text/css">
			...
			<g class="the24hours_2">
				<path d="M-148.7,359.2c1.1-2.4,3.4-4.5,6.7-6.4l5-2.9c2.2-1.3,3.8-2.4,4.7-3.3c1.4-1.4,2.1-3.1,2.1-4.9c0-2.2-0.6-3.9-1.9-5.1
					...
					c-1.7,1.5-2.8,3.2-3.3,5h20.2v4.4h-25.4C-150.5,364.3-149.8,361.5-148.7,359.2z"/>
				<path d="M-105.2,367.5v-9.1h-16.3v-4.6l17-23.5h3.9v24h5.5v4.1h-5.5v9.1H-105.2z M-105.3,354.4v-16.8l-11.9,16.8H-105.3z"/>
			</g>
			<polygon id="XMLID_470_" class="the24hours_1" points="-82.7,394.8 -82.7,350.8 -87.7,350.8 -87.7,394.8 -87.7,399.8 -82.7,399.8 
				-55.7,399.8 -55.7,394.8 "/>
			</svg>
			<p>Нефтебаза работает 24 часа 7 дней в неделю без выходных и праздников</p>
		</div>
		...
		<div class="iconline">
			...
			<g id="convenient_group">
				<path id="XMLID_494_" class="convinent_0" d="M168.6,210H50c-22.5,0-40.7-18.2-40.7-40.7V50.7C9.3,28.2,27.6,10,50,10h118.6
					c22.5,0,40.7,18.2,40.7,40.7v118.6C209.3,191.8,191.1,210,168.6,210z"/>
				<path id="XMLID_109_" class="convinient_1" d="M109.3,38.3c-9.8,0-18.8,3.2-26.1,8.6c-15.4,11.4-19.5,32.8-9.9,49.4l14,24.2l0,0l22,38.1
					l22-38.1l0,0l14-24.2c9.6-16.6,5.5-38-9.9-49.4C128.1,41.5,119.1,38.3,109.3,38.3z"/>
				<circle id="XMLID_491_" class="convinent_0" cx="109.3" cy="72.8" r="10"/>
				<polygon id="XMLID_111_" class="convinient_1" points="148.9,133.5 123.8,133.5 109.3,158.5 94.9,133.5 69.8,133.5 59.7,181.2 158.9,181.2 	
					"/>
			</g>
			</svg>
			<p>Удобное расположение вблизи магистрали М2 позволяет значительно сократить логистические расходы</p>
		</div>
